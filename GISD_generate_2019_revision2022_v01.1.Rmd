...
dir.create("Outfiles/2022_v01.1", showWarnings=T)
dir.create("Outfiles/2022_v01.1/Bund", showWarnings=T)
dir.create("Outfiles/2022_v01.1/Other", showWarnings=T)
dir.create("Outfiles/2022_v01.1/Stata", showWarnings=T)
setwd(home)
getwd()
```
...
id_dataset <- id_dataset %>% left_join(readRDS("Outfiles/2022_v01.1/Bevölkerung.rds"), by = c("Gemeindekennziffer", "GVBKennziffer", "Kreiskennziffer", "Raumordnungsregion Nr", "NUTS2"))


write_rds(id_dataset, paste0("Outfiles/2022_v01.1/ID_dataset_2022"))
```
...
write_dta(Gemeinden_ohne_Bevoelkerung, paste0("Outfiles/2022_v01.1/Gemeinden_ohne_Bevoelkerung.dta"))
...
write_dta(Workfile, paste0("Outfiles/2022_v01.1/Workfile_vorab.dta"))
...
write_dta(stata_data, paste0("Outfiles/2022_v01.1/Stata/Impdata_check_2019.dta"))
rm(stata_data)

# RDS-Datensatz rausschreiben
write_rds(Impdata.imputed, paste0("Outfiles/2022_v01.1/Impdata_check.rds"))
...
save(GISD_Komponents, file="Outfiles/2022_v01.1/GISD_Komponents.RData")
...
write_rds(Resultdataset, paste0("Outfiles/2022_v01.1/Resultdataset.rds"))
write_dta(Resultdataset, paste0("Outfiles/2022_v01.1/Stata/Resultdataset.dta"))
```
...
for(mykennziffer in exportlist$Kennziffern) {
  ...
  dir.create("Outfiles/2022_v01.1/", showWarnings=F)
  dir.create("Outfiles/2022_v01.1/Bund/", showWarnings=F)
  mydata <- outputdata.agg %>% ungroup() %>% select(mykennziffer, gisd_score, gisd_5, gisd_10, gisd_k, myname, year)
  write.csv(mydata, paste0("Outfiles/2022_v01.1/Bund/GISD_Bund_",mylabel,".csv"), row.names=FALSE, fileEncoding="UTF-8")
  ...
  write_dta(mydata, paste0("Outfiles/2022_v01.1/Bund/GISD_Bund_",mylabel,"_long.dta"))
  ...
  dir.create("Outfiles/2022_v01.1/Bundesland", showWarnings=F)  
  for(myland in ListeBula) {
    ...
    write.csv(mydata.bula, paste0("Outfiles/2022_v01.1/Bundesland/GISD_",myland,"_",mylabel,".csv"), row.names=FALSE, fileEncoding="UTF-8")
    ...
    write_dta(mydata.bula, paste0("Outfiles/2022_v01.1/Bundesland/GISD_",myland,"_",mylabel,".dta"))
  }
  }  
}
...
for (mykennziffer in c("PLZ2","PLZ3","PLZ4","PLZ5")) {
  ...
  dir.create( paste0("Outfiles/2022_v01.1"), showWarnings=F) 
  dir.create( paste0("Outfiles/2022_v01.1/Bund/"), showWarnings=F) 
