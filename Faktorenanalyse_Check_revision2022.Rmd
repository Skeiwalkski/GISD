...
TS_Bildung_4items_o <- Impdata.imputed %>% select(BeschaeftigtemitakadAbschluss,BeschaeftigteohneAbschluss,SchulabgaengerohneAbschluss, SchulabgaengermitHochschulreife)

TS_Bildung_4items_twadj <- Impdata.imputed %>% select(BeschaeftigtemitakadAbschluss,BeschaeftigteohneAbschluss,SchulabgaengerohneAbschluss_adj, SchulabgaengermitHochschulreife_adj)
...
#plot(TS_Bildung.pca)
TS_Bildung.pca <- prcomp(TS_Bildung_o, center = TRUE, scale. = TRUE, retx=TRUE)
#TS_Bildung.pca
...
TS_Bildung_4items_o.pca <- prcomp(TS_Bildung_4items_o, center = TRUE, scale. = TRUE, retx=TRUE)
TS_Bildung_4items_twadj.pca <- prcomp(TS_Bildung_4items_twadj, center = TRUE, scale. = TRUE, retx=TRUE)
