...
Lebenserwartung_Frauen <- read_excel("Data/Lebenserwartung/Lebenserwartung_female_15_16_17.xlsx", skip = 1, sheet = "Daten")
...
Lebenserwartung_Frauen <- Lebenserwartung_Frauen %>% group_by(Kreis) %>% mutate(Lebenserwartung_2016 = mean(Value)) %>% ungroup() %>% filter(Jahr == 2016) %>% select(Kreis, Lebenserwartung_2016)

Lebenserwartung_Männer <- read_excel("Data/Lebenserwartung/Lebenserwartung_male_15_16_17.xlsx", skip = 1, sheet = "Daten")
...
Lebenserwartung_Männer <- Lebenserwartung_Männer %>% group_by(Kreis) %>% mutate(Lebenserwartung_2016 = mean(Value)) %>% ungroup() %>% filter(Jahr == 2016) %>% select(Kreis, Lebenserwartung_2016)


dat_Lebenserwartung <- read.csv2("/Data/Lebenserwartung/Lebenserwartung_Geschlecht_15_16_17.xlsx") %>% mutate(Kreis = as.numeric(ï..Kennziffer), Lebenserwartung_Männer_2014 = Lebenserwartung.MÃ.nner) %>% select(-ï..Kennziffer, -Lebenserwartung.MÃ.nner, -Lebenserwartung.MÃ.nner.1)
