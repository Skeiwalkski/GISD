...
Workfile <- Workfile %>% mutate(Arbeitslosigkeit = round(Arbeitslosigkeit / ErwerbsfaehigeBevoelkerung * 1000, digits = 2), Arbeitslosigkeit=ifelse(is.nan(Arbeitslosigkeit),NA,Arbeitslosigkeit), Arbeitslosigkeit=ifelse(is.infinite(Arbeitslosigkeit),NA,Arbeitslosigkeit)) %>%
...
write_dta(Gemeinden_ohne_Bevoelkerung, paste0("Outfiles/Gemeinden_ohne_Bevoelkerung"))
...
Workfile <- Workfile %>%  group_by(Gemeindeverband) %>% 
  mutate(impu_arblos = ifelse(Bevoelkerung>0,na.approx(Arbeitslosigkeit),Arbeitslosigkeit),
         impu_oA=ifelse(Bevoelkerung>0,na.approx(SchulabgaengerohneAbschluss),SchulabgaengerohneAbschluss))  %>% 
...
write_rds(Impdata.imputed, paste0("Outfiles/Impdata_check_2019.rds"))
