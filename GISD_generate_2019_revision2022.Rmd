...
Resultdataset$TS_Bildung_adj <- as.numeric(((Resultdataset$BeschaeftigtemitakadAbschluss*-0.33)+(Resultdataset$BeschaeftigteohneAbschluss_adj*0.33)+(Resultdataset$SchulabgaengerohneAbschluss_adj*0.33))/2)
