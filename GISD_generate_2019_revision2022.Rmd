...
Workfile <- Workfile %>% mutate(ErwerbsfaehigeBevoelkerung = ifelse(Jahr < 2001, ErwerbsfaehigeBevoelkerungKreis, ErwerbsfaehigeBevoelkerung), Arbeitslosigkeit = ifelse(Jahr < 2001, ArbeitslosigkeitKreis, Arbeitslosigkeit)) %>% select(-ErwerbsfaehigeBevoelkerungKreis, -ArbeitslosigkeitKreis)
...
Impdata.imputed <- Impdata.imputed %>% 
  mutate(BeschaeftigteohneAbschluss_adj = Messaenderung_Besch(.,"BeschaeftigteohneAbschluss_adj"),
