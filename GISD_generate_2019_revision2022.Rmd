...
- Einlesen der INKAR-Daten
-Erstellen eines ID-Datensatzes
...
- INKAR-Daten der verschiednen ebenen (GVB und Kreis) werden in einem Datensatz zusammengespielt
- Anspielen der NUTS-2 Indikatoren
- Anspielen der Arbeitslosigkeit und Erwerbsfähigen Bevölkerung auf Kreisebene (1998 bis 2000)
- Ausschluss der Gemeinden ohne Bevölkerung
- Beschäftigte ohne Abschluss, Beschäftigte mit akad. Abschluss werden berechnet; SV beschäftigte Idikator wird entfernt
- Arbeitslosenquote wird errechnet; erwerbsfähige Bevölkerung wird entfernt
- Ausschreiben des bisherigen Workfiles als STATA-Datensatz
...
- Ausgabe der Missings nach indikator
- Ausgabe der Missings nach den beiden Hauptindikatoren (Arbeitslosigkeit, Schulabgänger ohne Abschluss)
