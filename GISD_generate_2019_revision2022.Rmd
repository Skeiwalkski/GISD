...
write_rds(id_dataset, paste0("Outfiles/2022/ID_dataset_2019"))
```
...
Resultdataset$TS_Bildung_adj <- as.numeric(((Resultdataset$SchulabgaengerohneAbschluss_adj*-0.33)+(Resultdataset$BeschaeftigtemitakadAbschluss*0.66))/2)
