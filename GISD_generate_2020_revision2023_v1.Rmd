...
author: "Lola Omar Soliman, Marvin Reis"
date: "21 11 2023"
...
if (!file.exists("Data/Referenz/Erzeugte Referenzen/Referenz_1998_2020.xlsx")) { # Falls noch nicht vorhanden
  source("Data/Referenz/Generate_Reference_2020.R") # Führe Skript aus (Skript zur Generierung muss jährlich aktualisiert werden)
  }
...
# Fälle betrachten: 16063104 (Amt Creuzburg)
...
write_rds(Resultdataset, paste0("Outfiles/",currentrevision,"/Resultdataset_raw.rds"))
write_dta(Resultdataset, paste0("Outfiles/",currentrevision,"/Stata/Resultdataset_raw.dta"))
```

## V. Korrektur ausgewählter Ausreißer im Einkommens-Teilscore

- Imputation durch Mittelwert des Vor- und Nachjahres mit Z-basierter Selektion (für einen tieferen Einblick siehe Score_Imputation.Rmd)
...
# Übernehmen und exportieren
Resultdataset.raw <- Resultdataset

Resultdataset <- Scores.neu %>% 
  select(-oldscore, -newscore, -Score_nrml)
