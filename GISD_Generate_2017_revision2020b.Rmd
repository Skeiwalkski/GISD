...
Impdata.imputed <- Impdata.imputed %>% group_by(Jahr) %>% 
          mutate(Bruttoverdienst = findInterval(Bruttoverdienst, quantile(Bruttoverdienst, probs=0:100/100 , type=9)),
                 ...
                 Einkommenssteuer = findInterval(Einkommenssteuer, quantile(Einkommenssteuer, probs=0:100/100 , type=9)),
                 Einkommenssteuer = findInterval(Einkommenssteuer, c(1:100)),) %>% ungroup()
