...
Resultdataset <- readRDS("Outfiles/2022_v03/Resultdataset.rds")
...
Corr_data <- Corr_data %>%  mutate(alos_q = findInterval(Arbeitslosigkeit, quantile(Arbeitslosigkeit,   probs=0:100/100, type=9)), alos_q = findInterval(alos_q, c(1:100)), beschAkad_q = findInterval(BeschaeftigtemitakadAbschluss_adj, quantile(BeschaeftigtemitakadAbschluss_adj,   probs=0:100/100 , type=9)),  beschAkad_q = findInterval(beschAkad_q, c(1:100)))
```
