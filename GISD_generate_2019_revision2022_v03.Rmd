...
for(mykennziffer in exportlist$Kennziffern) {
  ...
  write.csv(mydata, paste0("Outfiles/2022_v03/Bund/",mylabel,"/",mylabel,".csv"))
  ...
  dir.create( paste0("Outfiles/2022_v03/Bundesland/",myland), showWarnings=F)  
    ...
    write.csv(mydata.bula, paste0("Outfiles/2022_v03/Bundesland/",myland,"/",mylabel,"/",mylabel,".csv"))
...
for (mykennziffer in c("PLZ2","PLZ3","PLZ4","PLZ5")) {
  ...
  write.csv2(mydata, paste0("Outfiles/2022_v03/Bund/",mylabel,"/",mylabel,".csv"))
  mydata <- outputdata %>% ungroup() 
  names(mydata) <- gsub("\\.","_",make.names(names(mydata)))
  names(mydata) <- gsub("\\?","oe",names(mydata))
  names(mydata) <- gsub("\\?","ae",names(mydata))
