...
# Teilscores laden
Scores <- readRDS(paste0(inputpath, "Resultdataset_raw.rds")) %>% 
...
Scores.temp <- readRDS(paste0(inputpath, "Resultdataset_raw.rds")) %>%
...
```{r pruefung, message=FALSE, warning=FALSE}
