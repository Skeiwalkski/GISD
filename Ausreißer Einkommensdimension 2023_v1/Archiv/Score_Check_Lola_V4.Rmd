...
ggplot(Scores, aes(x = Jahr, y = Score, group = Gemeindekennziffer)) +
  ...
  labs(subtitle = "Teilscores (roh) des GISD",
       y = NULL) +
  plot_components
...
ggplot(Scores, aes(x = Jahr, y = Score_nrml, group = Gemeindekennziffer)) +
  geom_line(alpha = 0.3, linewidth = 0.1) +
  labs(subtitle = "Auf das Jahr normalisierte Teilscores des GISD",
       y = NULL) +
  plot_components

ggsave("Teilscores_nrml.png", device = "png",
       width = 210, height = 297, units = "mm")
...
# ggplot(rs.z.zeitreihe %>% filter(Bundesland == "Freistaat Bayern"),
#        aes(x = Jahr, y = z, group = Gemeindekennziffer,
...
# Scores pro Jahr und Dimension normalisieren
...
ggplot(scores.adj.prepped, aes(x = Jahr, y = Score_nrml, group = Gemeindekennziffer)) +
  ...
  labs(subtitle = "Adjusted Teilscores (pro Jahr und Dimension standardisiert)",
       y = NULL) +
  plot_components
ggsave("Teilscores_nrml_adj.png", device = "png",
       width = 210, height = 297, units = "mm")
...
ggplot(scores.adj.prepped, aes(x = Jahr, y = Score_nrml, group = Gemeindekennziffer,
  ...
  theme(legend.position=c(0.87, 0.5)) +
  guides(color=guide_legend(override.aes=list(alpha=1, linewidth=2)))
ggsave("Teilscores_nrml_adj_bl.png", device = "png",
       width = 210, height = 297, units = "mm")
