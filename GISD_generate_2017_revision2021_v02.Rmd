...
OW <- function(data,outcome_name){
  ...
  mymodell_ow <- lm(Outcome ~ Jahr_Dummy + Jahr_Dummy*OW, data = mydata, na.action="na.exclude")
  print(mymodell_ow)  
...
for(mykennziffer in exportlist$Kennziffern) {
  ...
  outputdata.agg <- outputdata %>% 
   ...
   #Achtung: Referenzrahmen für den Bevölkerungsstand ist das Referenzjahr. Die Varianz der Bevölkerung über die ahre wird nicht berücksichtigt.
  ...
  # Ausgabe Bund
  dir.create("C:/git_projects/GISD/Outfiles/", showWarnings=F)
  dir.create("C:/git_projects/GISD/Outfiles/2021_v2/", showWarnings=F)
  dir.create("C:/git_projects/GISD/Outfiles/2021_v2/Bund/", showWarnings=F)  
  dir.create(paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/",mylabel), showWarnings=F)
  mydata <- outputdata.agg %>% ungroup()
  write.csv(mydata, paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/",mylabel,"/",mylabel,".csv"))
  ...
  dir.create("C:/git_projects/GISD/Outfiles/2021_v2/Bundesland", showWarnings=F)  
  for(myland in ListeBula) {
  dir.create( paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bundesland/",myland), showWarnings=F)  
    dir.create( paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bundesland/",myland,"/",mylabel), showWarnings=F)  
    mydata <- outputdata %>% filter(Bundesland==myland) %>% ungroup() %>% dplyr::select(-Bundesland)
    write.csv(mydata, paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bundesland/",myland,"/",mylabel,"/",mylabel,".csv"))
    ...
    names(mydata) <- gsub("\\?","ue",names(mydata))
    names(mydata) <- gsub("\\?","ss",names(mydata))
    write_dta(mydata, paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bundesland/",myland,"/",mylabel,"/",mylabel,".dta"))
  }
  }  
}
...
for (mykennziffer in c("PLZ2","PLZ3","PLZ4","PLZ5")) {
  ...
  dir.create( paste0("C:/git_projects/GISD/Outfiles"), showWarnings=F)
  dir.create( paste0("C:/git_projects/GISD/Outfiles/2021_v2"), showWarnings=F) 
  dir.create( paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/"), showWarnings=F) 
  dir.create( paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/",mylabel), showWarnings=F) 
  mydata <- outputdata %>% ungroup() 
  write.csv2(mydata, paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/",mylabel,"/",mylabel,".csv"))
  mydata <- outputdata %>% ungroup() 
  names(mydata) <- gsub("\\.","_",make.names(names(mydata)))
  names(mydata) <- gsub("\\?","oe",names(mydata))
  names(mydata) <- gsub("\\?","ae",names(mydata))
  names(mydata) <- gsub("\\?","ue",names(mydata))
  names(mydata) <- gsub("\\?","ss",names(mydata))
  write_dta(mydata, paste0("C:/git_projects/GISD/Outfiles/2021_v2/Bund/",mylabel,"/",mylabel,"_long.dta"))
  }
