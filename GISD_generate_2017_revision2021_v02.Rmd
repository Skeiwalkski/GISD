...
for(mykennziffer in exportlist$Kennziffern) {
  ...
  # Ausgabe Bund
  dir.create("C:/data/GISD/Outfiles/", showWarnings=F)
  dir.create("C:/data/GISD/Outfiles/2021/", showWarnings=F)
  dir.create("C:/data/GISD/Outfiles/2021/Bund/", showWarnings=F)  
  dir.create(paste0("C:/data/GISD/Outfiles/2021/Bund/",mylabel), showWarnings=F)
  mydata <- outputdata.agg %>% ungroup()
  write.csv(mydata, paste0("C:/data/GISD/Outfiles/2021/Bund/",mylabel,"/",mylabel,".csv"))
  ...
  dir.create("C:/data/GISD/Outfiles/2021/Bundesland", showWarnings=F)  
  for(myland in ListeBula) {
  dir.create( paste0("C:/data/GISD/Outfiles/2021/Bundesland/",myland), showWarnings=F)  
    dir.create( paste0("C:/data/GISD/Outfiles/2021/Bundesland/",myland,"/",mylabel), showWarnings=F)  
    mydata <- outputdata %>% filter(Bundesland==myland) %>% ungroup() %>% dplyr::select(-Bundesland)
    write.csv(mydata, paste0("C:/data/GISD/Outfiles/2021/Bundesland/",myland,"/",mylabel,"/",mylabel,".csv"))
    ...
    names(mydata) <- gsub("\\?","ue",names(mydata))
    names(mydata) <- gsub("\\?","ss",names(mydata))
    write_dta(mydata, paste0("C:/data/GISD/Outfiles/2021/Bundesland/",myland,"/",mylabel,"/",mylabel,".dta"))
  }
  }  
}
...
for (mykennziffer in c("PLZ2","PLZ3","PLZ4","PLZ5")) {
  ...
  dir.create( paste0("C:/data/GISD/Outfiles"), showWarnings=F)
  dir.create( paste0("C:/data/GISD/Outfiles/2021"), showWarnings=F) 
  dir.create( paste0("C:/data/GISD/Outfiles/2021/Bund/"), showWarnings=F) 
  dir.create( paste0("C:/data/GISD/Outfiles/2021/Bund/",mylabel), showWarnings=F) 
  mydata <- outputdata %>% ungroup() 
  write.csv2(mydata, paste0("C:/data/GISD/Outfiles/2021/Bund/",mylabel,"/",mylabel,".csv"))
  mydata <- outputdata %>% ungroup() 
  names(mydata) <- gsub("\\.","_",make.names(names(mydata)))
  names(mydata) <- gsub("\\?","oe",names(mydata))
  names(mydata) <- gsub("\\?","ae",names(mydata))
  names(mydata) <- gsub("\\?","ue",names(mydata))
  names(mydata) <- gsub("\\?","ss",names(mydata))
  write_dta(mydata, paste0("C:/data/GISD/Outfiles/2021/Bund/",mylabel,"/",mylabel,"_long.dta"))
  }
