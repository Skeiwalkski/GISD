...
#
#Problemfall_2012 <- Impdata.imputed %>% filter(Gemeindekennziffer == 1054088) %>% select(Jahr, #BeschaeftigteohneAbschluss, BeschaeftigteohneAbschluss_adj, BeschaeftigtemitakadAbschluss, #BeschaeftigtemitakadAbschluss_adj)
#Problemfall_2012
#
```
